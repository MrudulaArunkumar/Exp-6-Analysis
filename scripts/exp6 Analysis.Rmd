...
Exp6agg_IES <- aggregate(Exp6test[,c("RT_ifo","ErrorRate", "ACC_trials")], by = list(participant = Exp6test$participant,
...
Exp6agg_IES$BIS <- Exp6agg_IES$ZPC - Exp6agg_IES$ZRT
...
ezPlot(data = Exp6overSRB_Agg,
        dv = RT_ifo,
        wid = participant,
        within = .(OvershadowSRB,ResponseType),do_bars = FALSE,x=ResponseType,split = OvershadowSRB) +theme_classic()+ylim(550,600)
